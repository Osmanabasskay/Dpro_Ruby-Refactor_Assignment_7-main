...
def check_out
  ...
  @items.each do |item|
    ...
    # Transfer funds from customer (self.owner) to the item's owner
    self.owner.wallet.transfer(item.owner.wallet, item_total)

    # Transfer item ownership to the customer
